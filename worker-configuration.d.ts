/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 82a1487c260e00dcf05e4fd97cb0b814)
...
interface __BaseEnv_Env {
	...
	BROWSER_RATE_LIMITER: RateLimit;
	CONTACT_RATE_LIMITER: RateLimit;
	BROWSER: BrowserRun;
	BILLING_ENABLED: "true";
	DODOPAYMENTS_ENVIRONMENT: "live_mode";
	DODOPAYMENTS_ONE_TIME_PRODUCT_ID: "pdt_0NkfoXx7VzaIB8nxSDPdy";
	DODOPAYMENTS_ON_DEMAND_PRODUCT_ID: "pdt_0NkfoY14HjKxMkVev8up7";
	CLOUDFLARE_API_KEY: string;
	TURNSTILE_SITE_KEY: string;
	TURNSTILE_SECRET_KEY: string;
	HANKO_AUTH_DOMAIN: string;
	ACCOUNT_CREDITS: DurableObjectNamespace<import("./src/worker").AccountCredits>;
	ANONYMOUS_QUOTA: DurableObjectNamespace<import("./src/worker").AnonymousQuota>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "AccountCredits" | "AnonymousQuota";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BILLING_ENABLED" | "DODOPAYMENTS_ENVIRONMENT" | "DODOPAYMENTS_ONE_TIME_PRODUCT_ID" | "DODOPAYMENTS_ON_DEMAND_PRODUCT_ID" | "CLOUDFLARE_API_KEY" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "HANKO_AUTH_DOMAIN">> {}
}
