...
const STATIC_PATHS = [
  '/', '/amazon/', '/bluesky/', '/google-news/', '/instagram/', '/mastodon/', '/reddit/', '/shopify/', '/soundcloud/', '/spotify/', '/tiktok/', '/vimeo/', '/x/', '/youtube/',
  '/docs/', '/docs/quickstart/', '/docs/api/', '/docs/schema/', '/docs/sources/', '/docs/limits/', '/docs/limitations/',
