...
export const platformArticles: PlatformArticle[] = [
  ...
  },
  {
    ...
    introduction: 'SoundCloud pages center an interactive audio player, while many AI workflows only need the public title, creator, description, artwork, type, and source URL. A compact metadata document is easier to index and attribute.',
